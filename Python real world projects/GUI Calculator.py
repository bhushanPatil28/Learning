...
class Calculator:
    def __init__(self, master):
        ...
        Button(width=11, height=4, text='(', relief='flat', bg='lightgray', command=lambda:self.show('(')).place(x=0, y=50)
        Button(width=11, height=4, text=')', relief='flat', bg='lightgray', command=lambda:self.show(')')).place(x=90 , y=50)
        Button(width=11, height=4, text='%', relief='flat', bg='lightgray', command=lambda:self.show('%')).place(x=180 , y=50)
        ...
        Button(width=11, height=4, text='-', relief='flat', bg='lightgray', command=lambda:self.show('-')).place(x=270 , y=200)
    ...
    def show(self, value):
        self.entry_value += str(value)  # Append the pressed value to the current entry_value
    ...
    def solve(self):
        try:
            ...
            # Handle any exception that might occur during evaluation
